        ...
        <div class="col-md-4">
          <form @submit.prevent="myCreate">
            ...
            <div class="mb-2">
              ...
              />
              <div
                v-if="contact.remind_day && !isValidRemindDay"
            ...
            <div class="mb-2">
              ...
              />
              <div
                v-if="contact.notify_token && !isValidNotifyToken"
                class="invalid-feedback"
              >
            ...
            <div class="mb-2">
              <textarea
                ...
                rows="5"
                placeholder="Memo"
                :class="{ 'is-invalid': contact.memo && !isValidMemo }"
              ></textarea>
