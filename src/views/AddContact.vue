            ...
            <div class="row">
                <div class="col-md-4">
                    <form @submit.prevent="myCreate">
                        ...
                        <div class="mb-2">
                            <input v-model="contact.remind_day" type="number" class="form-control" placeholder="Remind Day"
                                :class="{ 'is-invalid': contact.remind_day && !isValidRemindDay }">
                        ...
                        <div class="mb-2">
                            <input v-model="contact.notify_token" type="text" class="form-control"
                                placeholder="Notify Token"
                                :class="{ 'is-invalid': contact.notify_token && !isValidNotifyToken }">
