            ...
            <form @submit.prevent="createAccount">
               ...
               <div class="input-div one">
                  ...
                  <div class="div">
                     ...
                     <div v-if="email && !isValidEmail" class="invalid-feedback"><br /><br /><br />
               ...
               <div class="input-div pass">
                  ...
                  <div class="div">
                     <input type="password" class="input" placeholder="Confirm Password" v-model="confirm_password"
               ...
               <br />
               <br />
               <input type="submit" class="btn_blue" value="Signup" :disabled="!isFormValid">
            </form>
            <!-- <pre>{{ isFormValid }}</pre> -->
         </div>
      </div>
