        ...
        <div class="col-md-4">
          <form @submit.prevent="myUpdate">
            <div class="mb-2" v-if="contact && contact.fields">
              ...
              />
              <div
                v-if="contact.fields.name && !isValidName"
            ...
            <div class="mb-2" v-if="contact && contact.fields">
              <input
                v-model="contact.fields.remind_day"
                type="number"
                class="form-control"
                placeholder="Remind Day"
                :class="{
                  'is-invalid': contact.fields.remind_day && !isValidRemindDay,
                }"
              />
              <div
                v-if="contact.fields.remind_day && !isValidRemindDay"
                class="invalid-feedback"
              >
            ...
            <div class="mb-2" v-if="contact && contact.fields">
              <div class="form-control date-picker-container">
                <datepicker
                  :format="'yyyy-MM-dd'"
                  class="no_border"
                  v-model="contact.fields.rent_start"
            ...
            <div class="mb-2" v-if="contact && contact.fields">
              <div class="form-control date-picker-container">
                <datepicker
                  :format="'yyyy-MM-dd'"
                  class="no_border"
                  v-model="contact.fields.rent_end"
            ...
            <div class="mb-2" v-if="contact && contact.fields">
              <input
                v-model="contact.fields.notify_token"
                type="text"
                class="form-control"
              ...
              />
              <div
                v-if="contact.fields.notify_token && !isValidNotifyToken"
                class="invalid-feedback"
              >
            ...
            <div class="mb-2">
              <textarea
                v-model="contact.fields.memo"
                class="form-control"
                rows="5"
                placeholder="Memo"
                :class="{ 'is-invalid': contact.fields.memo && !isValidMemo }"
              ></textarea>
              <div
                v-if="contact.fields.memo && !isValidMemo"
                class="invalid-feedback"
              >
